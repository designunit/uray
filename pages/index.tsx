    ...
    return (
        <main>
            ...
            <div className={'wrapper'}>
                ...
                <p>
                    В указанный период максимальная общая численность аудитории Набе- режной составила 83 человек, что, например, в 4 раза больше численно- сти аудитории на площади «Планета звезд».
                </p>
                ...
                />
                <p>
                Несмотря на отсутствие городских инфраструктур, благоустройства и близости точек притяжения, наибольшее разнообразие сценариев демон- стрирует территория «Набережная».
                </p>
                <p>
                Максимальный диапазон наблюдаемых практик включает 10 вариантов: идут, стоят, сидят, играют, с коляской, в смартфоне, с собакой, с велосипе- дом, занимаются спортом, едят/пьют. При этом из указанных практик три варианта: гуляют с собакой, на велосипеде, занимаются спортом — были уникальными и не встречались в других исследуемых общественных про- странствах. Диапазон практик в Спортсквере и площадь Планета Звезд сопоставим и поддерживает 5-6 вариантов: идут, сидят, в смартфоне, едят/пьют, играют, с коляской.
                </p>
                <p>
                Максимальное разнообразие аудиторий из пяти возрастных групп: взрос- лые, пожилые, молодежь, школьники, дошкольники — было представлено на Набережной. Аудитории Спортсквера и площади «Планета Звезд» состоят из 3 групп пользователей, при этом Спортсквер используется пожилыми и взрослыми с детьми, а площадь «Планеты Звезд» привлекает молодежь и школьников.
                </p>
                ...
                <p>
                В ходе анализа активности пользователей терри- тории Спортсквера (12 человек, 6 практик, 3 аудито- рии) выявлены следующие тенденции:</p>
                <p>
                Категория «едят/пьют» — одна из превалирующих практик в Спортсквере. Наличие инфраструктур, поддерживающих подобные практики, дает воз- можность пользователям дольше находиться в городской среде — они «сидят», «идут», играют».
                </p>
                <p>
                Спортсквер удовлетворяет запросам и на длитель- ные прогулки: мамы с колясками — одни из поль- зователей пространства.</p>
                <p>
                Порядка половины всей аудитории Спортсквера — дети и пожилые, что говорит о безопасности пространства: на территории есть необходимая инфраструктура.
                </p>
                ...
                <p>
                В ходе анализа активности пользователей пло- щади «Планета Звезд» (23 человека, 4 практики, 3 аудитории) выявлены следующие тенденции:
                </p>
                <p>
                Площадь «Планета Звезд», в отличие от двух пре- дыдущих открытых городских пространств, явля- ется не транзитным, а пространством пребывания: «сидят», «едят/пьют» — преобладающие практики у взрослого населения и молодежи на площади.
                </p>
                <p>
                Так же это пространство популярно у школьников как место времяпрепровождения.
                </p>
                ...
                />
                <p>
                Парк «Солнышко», Спортсквер, площадь «Планета Звезд», сквер Романтиков, Набережная реки Конда — самые посещаемые пространства города в повседневном сценарии. Эти пространства имеют устойчивые практики времяпрепро-вождения, для поддержания которых необходимы комфортные условия и современная инфраструктура.
                </p>

    ...
    return (
        <main>
            ...
            <div className={'wrapper'}>
                ...
                <p>
                    Указанные графики были построены на основании данных наблюдений стационарных активностей, собранных в будний день в период с 11.30 до 14.30 на территориях трех общественных пространств г Урай: территория Набережной р. Конды, Спортсквер, площадь «Планета Звезд».
                </p>
                <p>
                    Несмотря на отсутствие городских инфраструктур и благоустройства, близости точек притяжения, наибольшее разнообразие сценариев демон- стрирует территория «Набережная». Максимальный диапазон наблюдаемых практик включает 10 вариантов: идут, стоят, сидят, играют, с коляской, в смартфоне, с собакой, с велоси- педом, занимаются спортом, едят/пьют. Из указанных практик 3 варианта «гуляют с собакой», «на велосипеде», «занимаются спортом» были уни- кальными и не встречались в других исследуемых общественных про- странствах. Диапазон практик в Спортсквере и площадь Планета Звезд сопоставим и поддерживает 5-6 вариантов: идут, сидят, в смартфоне, едят/пьют, играют, с коляской.
                </p>
                ...
                <p>
                    В ходе анализа активности пользователей (83 человека, 10 практик, 5 аудиторий) на береговой территории реки Конды выявлены следующие тенденции: На данный момент территория выполняет прогулочно-рекреационную функцию — большая часть пользователей — «идет». Набережная является дублирующим транзитом главной улицы города с вдоль реки.
                </p>
                <p>
                    Вместе с этим на набережной зафиксированы практики, не реализованные в других открытых городских пространствах города: жители гуляют с коляской и питомцами, занимаются спортом на открытом воздухе, катаются на велосипеде, а так же останавливаются, чтобы полюбоваться на реку Конду. На набережной представлено максимальное количество аудиторий, включая и самые требовательные: дети (дошкольники и школьники) и пожилые.
                </p>
                ...
                <p>
                    В ходе анализа активности пользователей территории Спортсквера (12 человек, 6 практик, 3 аудитории) выявлены следующие тенденции: Категория «едят/пьют» — одна из превалирующих практик в Спортсквере, что дает возможность пользователям дольше находиться в городской среде — они «сидят», «идут», играют».
                </p>
                <p>
                    Спортсквер удовлетворяет запросам и на длительные прогулки: мамы с колясками — одни из пользователей пространства. Порядка половины всей аудитории Спортсквера дети и пожилые, что говорит о безопасности пространства и его подготовленности к пользователю: на территории есть необходимая инфраструктура.
                </p>
                ...
                <p>
                    На представленных тепловых картах видна динамика интенсивности использования открытых городских пространств города Урай различными группами жителей в период с 12 до 20 часов.
                    Спортсвкер, площадь «Планета Звезд», набережная р. Конды, Мемориал Памяти — наиболее популярные пространства, причем Спортсквер активно используется в течении всего дня, а площадь «Планета Звезд» преимущественно в дневное и вечернее время.
                </p>
                ...
                <p>
                    Парк «Солнышко», Спортсквер, площадь «Планета Звезд», сквер Романтиков, Набережная р. Конда — самые посещаемые пространства города в течении будних дней. Эти пространства имеют устойчивые практики времяпрепровожде- ния, для которых необходимы комфортные условия и современная инфрастуктура.
                </p>
                ...
                <p>
                    По данным социологического опроса в повседневных сценариях большинство общественных пространств города используется различными возрастными группами. Исключениями стали площадь Первооткрывателей, о которой не упомянул ни один человек старшего возраста, и бульвар Содружества, который остался без внимания предста- вителей молодежи.
                </p>

    ...
    return (
        <main>
            ...
            <div className={'wrapper'}>
                ...
                <p>
                    Парк «Солнышко», Спортсквер, площадь «Планета Звезд», сквер Романтиков, Набережная р. Конда — самые посещаемые пространства города в течении будних дней. Эти пространства имеют устойчивые практики времяпрепровождения, для которых необходимы комфортные условия и современная инфрастуктура.
                </p>
